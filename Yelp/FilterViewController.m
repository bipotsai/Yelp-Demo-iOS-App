...
// the datastructure to be passed back from the delated to the mainview controller. this will nbe built by reading the selected catogoroes
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    //    NSLog(@"%@", [NSString stringWithFormat:@"Section :%ld", indexPath.section ]);
